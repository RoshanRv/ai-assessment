...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from "@/components/generate-comic/UI/dialog";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/components/generate-comic/UI/select";

import { Input } from "@/components/generate-comic/UI/input";

import { Label } from "./label";
import { Field } from "./field";
import { localStorageKeys } from "./localStorageKeys";
import { defaultSettings } from "./defaultSettings";
import { Slider } from "@/components/generate-comic/UI/slider";
      ...
      <DialogContent className="w-full sm:max-w-[500px] md:max-w-[700px]">
        ...
        <div className="overflow-y-scroll h-[75vh] md:h-[70vh]">
          {isConfigReady && (
            <Field>
              <Label>
                (new!) Control the number of pages:{" "}
          ...
          <div className="grid gap-4 pt-8 pb-1 space-y-1 text-stone-800">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="HUGGINGFACE">
                    Custom Hugging Face model (recommended)
                  </SelectItem>
                  <SelectItem value="REPLICATE">
                    Custom Replicate model (will use your own account)
                  </SelectItem>
                  <SelectItem value="OPENAI">
                    DALL·E 3 by OpenAI (partial support, will use your own
                    account)
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            {renderingModelVendor === "REPLICATE" && (
              <>
                <Field>
                  <Label>
                    Replicate API Token (you will be billed based on Replicate
                    pricing):
                  </Label>
                  <Input
                    className={fonts.actionman.className}
            ...
            <p className="text-sm text-zinc-700 italic">
              🔒 Settings such as API keys are stored inside your browser and
              aren&apos;t kept on our servers.
            </p>
          </div>
        </div>
