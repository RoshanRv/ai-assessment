        ...
        {assessments.length === 0 ? (
          ...
          <div className="grid grid-cols-3 gap-6 items-center ">
            {assessments.map((assess) => (
              <div className="p-3 flex flex-col gap-2 boxShadow border-[3px] bg-white transition-all z-10 border-priClr">
                <div className="flex gap-4 items-center ">
                  <h1 className="text-2xl font-semibold capitalize ">
                    {assess?.topic}
                  </h1>
                  {/* DIFFICULTY */}
                  <p className="text-xs px-4 py-0.5 rounded-sm text-white font-semibold capitalize bg-priClr">
                    {assess?.difficulty}
                  </p>
                </div>
